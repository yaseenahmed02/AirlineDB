...
CREATE TABLE Ticket (
  ...
  FOREIGN KEY (FlightNum) REFERENCES Flight(Flight_Number)
);
...
CREATE TABLE Manages (
    ...
    EID INT,
    PRIMARY KEY (TID, EID),
    FOREIGN KEY (TID) REFERENCES Ticket(ID),
...
CREATE TABLE Operates (
    EID INT,
    FNum VARCHAR(10),
    PRIMARY KEY (EID, FNum),
    FOREIGN KEY (EID) REFERENCES Employee(ID),
    FOREIGN KEY (FNum) REFERENCES Flight(Flight_Number)
);

INSERT INTO Customer(First, Middle, Last, DOB, Gender, Passport_Number, Phone_Number, Email_Address) VALUES
('Ishan', ' ', 'Lamba', '2001-08-13', 'M', '257877968', '202-578-6960', 'ishanlambda23@vt.edu'),
...
INSERT INTO Customer_Age(DOB, Age) VALUES
('2001-08-13', '21'),
('2002-01-03', '21'),
('2001-04-27', '21'),
('2001-05-21', '21'),
...
INSERT INTO Baggage(Weight, Status) VALUES 
('13.05', 'ARRIVED'),
('21.53', 'ARRIVED'),
('20.90', 'CHECKED-IN'),
('30.20', 'ARRIVED'),
...
INSERT INTO Aircraft (Tail_Number, Model, Creation_Date) VALUES
...
INSERT INTO Aircraft_Specs (Model, Max_Capacity, Max_Weight, Travel_Distance) VALUES
...
INSERT INTO Flight (Flight_Number, Date, Num_Passengers, Num_Crew, Departure_Time, Arrival_Time, Status, Tail_Num) VALUES
...
INSERT INTO Ticket (Class, Date, Seat_Number, Num_Bags, Cust_ID, FlightNum) VALUES
...
INSERT INTO Airport (Code, Name, Num_Terminals, City, Country) VALUES
...
INSERT INTO Employee (ID, First, Middle, Last, DOB, Gender, Role, Wage, HireDate, EmailAddress, AirportCode) VALUES 
...
INSERT INTO Manages (TID, EID) VALUES
(1, 51),
(2, 52),
(3, 53),
(4, 54),
...
INSERT INTO Operates (EID, FNum) VALUES
(1, '1'),
(2, '1'),
(13, '1'),
(14, '1'),
...
INSERT INTO Ticket_Baggage(Ticket_ID, Baggage_ID) VALUES
('1', '10'),
('2', '7'),
('3', '20'),
('4', '18'),
...
INSERT INTO Employee_Age (DOB, Age) VALUES
('1967-01-23', 56), 
('1968-03-09', 55), 
('1968-06-09', 54), 
('1968-07-04', 54), 
